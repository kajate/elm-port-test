...
var _rtfeldman$elm_css$Css$animationIterationCount = function (arg) {
	return A2(_rtfeldman$elm_css$Css$prop1, 'animation-iteration-count', arg);
};
var _rtfeldman$elm_css$Css$animationDuration = function (arg) {
	return A2(_rtfeldman$elm_css$Css$prop1, 'animation-duration', arg);
};
var _rtfeldman$elm_css$Css$animationDelay = function (arg) {
	return A2(_rtfeldman$elm_css$Css$prop1, 'animation-delay', arg);
};
...
var _rtfeldman$elm_css$Css$infinite = {value: 'infinite', infinite: _rtfeldman$elm_css$Css_Structure$Compatible, numberOrInfinite: _rtfeldman$elm_css$Css_Structure$Compatible};
var _rtfeldman$elm_css$Css$ms = function (amount) {
	return {
		value: A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(amount),
			'ms'),
		duration: _rtfeldman$elm_css$Css_Structure$Compatible
	};
};
var _rtfeldman$elm_css$Css$sec = function (amount) {
	return {
		value: A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(amount),
...
var _rtfeldman$elm_css$Css$Infinite = F3(
	function (a, b, c) {
		return {value: a, numberOrInfinite: b, infinite: c};
	});
...
var _rtfeldman$elm_css$Css$int = function (val) {
	return {
		...
		numberOrInfinite: _rtfeldman$elm_css$Css_Structure$Compatible,
...
var _user$project$Main$sendInterval = _elm_lang$core$Native_Platform.outgoingPort(
	'sendInterval',
	function (v) {
		return v;
	});
		...
		switch (_p0.ctor) {
			case 'Fire':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$toJs('hello')
				};
			case 'Points':
				return {
					ctor: '_Tuple2',
			...
			case 'Interval':
				var newInterval = model.interval - 50;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{interval: newInterval}),
					_1: _user$project$Main$sendInterval(newInterval)
				};
			default:
				var newInterval = model.interval + 50;
				return {
...
var _user$project$Main$fromJs = _elm_lang$core$Native_Platform.incomingPort('fromJs', _elm_lang$core$Json_Decode$int);
var _user$project$Main$Model = F2(
	function (a, b) {
		return {points: a, interval: b};
	});
var _user$project$Main$IntervalUp = {ctor: 'IntervalUp'};
var _user$project$Main$Interval = {ctor: 'Interval'};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$IntervalUp),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('slower'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$Interval),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('faster'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _rtfeldman$elm_css$Html_Styled$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Milliseconds: ',
											_elm_lang$core$Basics$toString(model.interval))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Main$Points = function (a) {
	return {ctor: 'Points', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$fromJs(_user$project$Main$Points);
};
var _user$project$Main$main = _rtfeldman$elm_css$Html_Styled$program(
	{init: _user$project$Main$init, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})();
var _user$project$Main$Fire = {ctor: 'Fire'};
